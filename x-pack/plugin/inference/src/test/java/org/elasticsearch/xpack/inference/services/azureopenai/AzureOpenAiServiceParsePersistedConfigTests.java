...
public class AzureOpenAiServiceParsePersistedConfigTests extends AbstractParsePersistedConfigTests {
    public AzureOpenAiServiceParsePersistedConfigTests(AzureOpenAiSecretsTypes secretsType, TestCase testCase) {
