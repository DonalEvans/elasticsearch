...
public class FireworksAiServiceParsePersistedConfigTests extends AbstractParsePersistedConfigTests {
    public FireworksAiServiceParsePersistedConfigTests(TestCase testCase) {
