...
public abstract class AbstractParseRequestConfigTests extends AbstractInferenceServiceParameterizedTests {
    ...
    private record ServiceParserParams(SenderService<?> service, Map<String, Object> requestConfig, TestConfiguration testConfiguration) {}
            ...
            new TestCase[][] {
                    ...
                    ).build() },
                {
                    new TestCaseBuilder(
                        ...
                        (testConfig, minimalSettings) -> requestConfig(
                            testConfig,
                        ...
                        .build() },
                {
                    new TestCaseBuilder(
                        ...
                        (testConfig, minimalSettings) -> {
                            var requestConfigMap = requestConfig(
                                testConfig,
                                testConfig.commonConfig().defaultTaskType(),
                                false,
                                minimalSettings
                        ...
                        (params, listener) -> params.service.parseRequestConfig(
                            INFERENCE_ENTITY_ID,
                            params.testConfiguration.commonConfig().defaultTaskType(),
                            params.requestConfig,
                            listener
                        ),
                        // We expect failure, so the expected task type is irrelevant
    ...
    public void testRequestConfig() throws Exception {
        ...
        var requestConfig = testCase.createRequestConfig.apply(testConfiguration, testCase.minimalSettings);
