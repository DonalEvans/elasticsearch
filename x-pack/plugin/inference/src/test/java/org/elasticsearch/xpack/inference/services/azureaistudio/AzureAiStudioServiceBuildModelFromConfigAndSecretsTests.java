...
public class AzureAiStudioServiceBuildModelFromConfigAndSecretsTests extends AbstractBuildModelFromConfigAndSecretsTests {
    public AzureAiStudioServiceBuildModelFromConfigAndSecretsTests(AzureAiStudioProvider provider, TestCase testCase) {
