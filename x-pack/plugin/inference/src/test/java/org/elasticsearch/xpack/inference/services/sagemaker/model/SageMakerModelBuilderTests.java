...
public class SageMakerModelBuilderTests extends ESTestCase {
    ...
    public void testUpdateModelWithEmbeddingDetails_NullSimilarityInOriginalModel_Elastic() {
        testUpdateModelWithEmbeddingDetails("elastic", null, null);
    }
    ...
    private static void testUpdateModelWithEmbeddingDetails(
        ...
        var embeddingModel = new SageMakerModelBuilder(new SageMakerSchemas()).fromRequest(
            inferenceId,
        ...
        var updatedModel = SageMakerModelBuilder.updateModelWithEmbeddingDetails(embeddingModel, newDimensions);
