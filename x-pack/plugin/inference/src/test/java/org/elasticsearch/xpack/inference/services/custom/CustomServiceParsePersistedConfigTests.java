...
public class CustomServiceParsePersistedConfigTests extends AbstractParsePersistedConfigTests {
    public CustomServiceParsePersistedConfigTests(TestCase testCase) {
