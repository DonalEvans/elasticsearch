...
public class AzureOpenAiServiceBuildModelFromConfigAndSecretsTests extends AbstractBuildModelFromConfigAndSecretsTests {
    public AzureOpenAiServiceBuildModelFromConfigAndSecretsTests(AzureOpenAiSecretsTypes secretsType, TestCase testCase) {
