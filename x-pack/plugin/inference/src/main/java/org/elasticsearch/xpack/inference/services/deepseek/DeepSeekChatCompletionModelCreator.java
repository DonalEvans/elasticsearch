...
/**
 * Creates {@link DeepSeekChatCompletionModel} instances from config maps
 * or {@link ModelConfigurations} and {@link ModelSecrets} objects.
 */
public class DeepSeekChatCompletionModelCreator implements ModelCreator<DeepSeekChatCompletionModel> {
    @Override
    public DeepSeekChatCompletionModel createFromMaps(
        ...
        return new DeepSeekChatCompletionModel(inferenceId, taskType, service, serviceSettings, secretSettings);
    }
